 ...
 */
class QuestionsDisplayRoute extends AbstractRoutes
{
    /**
    ...
    function __invoke(Request $request, Response $response, array $args)
    {
        ...
        $this->displayAllQuestionsAction();
    }

    public function displayAllQuestionsAction()
    {
        $controller = new Controller\IndexController($this->container);
        $recentPosts = $controller->getRecentPosts();
        $displayedPosts = $controller->getPosts("Questions");
